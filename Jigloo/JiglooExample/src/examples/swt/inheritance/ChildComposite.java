...
public class ChildComposite extends AbstractParentComposite {
	...
	* in any other situation.
	...
	public static Object getGUIBuilderInstance(Composite parent, int style) {
		return new ChildComposite(parent, style, Boolean.FALSE);
	}
	 ...
	 */
	public ChildComposite(Composite parent, int style, Boolean initGUI) {
		super(parent, style);
	}
	...
	*/
	public static void showGUI() {
		...
		ChildComposite inst = new ChildComposite(shell, SWT.NULL);
