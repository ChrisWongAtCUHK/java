package examples.swing.slidergame;
...
public class SliderGame extends JFrame {
	...
	private class ButtonEvents extends MouseInputAdapter {
		...
		public void mousePressed(java.awt.event.MouseEvent e) {
			...
			if (!solved && check(buttons.indexOf(b))) {
				...
				dragTargetArea =
					((JButton) buttons.get(hiddenIndex)).getBounds();
	...
	private javax.swing.JPanel getJPanel() {
		if (jPanel == null) {
			...
			java.awt.GridLayout layGridLayout18 = new java.awt.GridLayout();
			layGridLayout18.setRows(4);
			jPanel.setLayout(layGridLayout18);
